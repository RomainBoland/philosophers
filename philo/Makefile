...
SRC = srcs/main.c srcs/utils.c srcs/monitor.c srcs/routine.c srcs/cleanup.c \
	srcs/init.c srcs/utils2.c srcs/routine2.c
...
$(OBJ_DIR)%.o: srcs/%.c includes/philo.h
